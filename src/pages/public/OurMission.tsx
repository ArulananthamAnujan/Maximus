...
const VALUES = [
  {
    icon: Heart,
    title: 'Care',
    desc: "We genuinely care about every learner's journey, providing personalised attention and support every step of the way.",
    color: 'text-rose-500',
    bg: 'bg-rose-50',
  ...
  },
  {
    icon: Star,
    title: 'Clarity',
    desc: 'We believe in clear communication, structured learning paths, and transparent guidance so learners always know where they stand.',
  ...
  },
  {
    icon: Target,
    title: 'Commitment',
    desc: 'We are fully committed to student success — from the first lesson to the final certificate, we never stop believing in you.',
    color: 'text-sky-600',
    bg: 'bg-sky-50',
  ...
  },
  {
    ...
    desc: 'We prepare learners not just for local success, but for opportunities on a global stage — with world-class skills.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-28 pb-20 bg-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-playfair text-5xl sm:text-6xl font-bold text-white mb-6">
            Guiding Aspirants with<br />
            <span className="text-sky-400">Care, Clarity & Commitment</span>
          </h1>
          <p className="text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto">
            At Maximus Academy, our mission is to empower every learner with the knowledge, skills, and confidence they need to succeed on a global stage — one lesson at a time.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-5 text-slate-600 leading-relaxed">
                <p>
                  Maximus Academy was founded on a simple but powerful belief: every motivated learner deserves access to world-class education. We exist to bridge the gap between aspiration and achievement.
                </p>
                <p>
                ...
                <p>
                  We believe education transforms lives — and at Maximus Academy, we take that responsibility seriously. Every course, every lesson, and every interaction is designed with your success in mind.
                </p>
              </div>
              <div className="mt-8 flex gap-4">
                <Link to="/courses" className="px-6 py-3 bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-xl transition-colors flex items-center gap-2">
                  Our Courses <ArrowRight className="w-4 h-4" />
                </Link>
                <Link to="/about" className="px-6 py-3 border-2 border-slate-200 text-slate-700 font-bold rounded-xl hover:border-sky-400 hover:text-sky-600 transition-colors">About Us</Link>
              </div>
            </div>
            <div className="relative">
              <img
                src="https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg"
                alt="Students at Maximus Academy"
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-sky-600 font-semibold text-sm uppercase tracking-wider mb-2">What Drives Us</p>
            <h2 className="font-playfair text-4xl font-bold text-slate-900 mb-4">Our Core Values</h2>
            <p className="text-slate-500 max-w-xl mx-auto">These values are not just words — they are embedded in everything we do at Maximus Academy.</p>
          </div>
      ...
      <section className="py-16 bg-sky-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sky-100 mb-8">Join the growing community of learners who are achieving their goals with Maximus Academy.</p>
